    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'text-muted pull-left datepicker-previous-wrapper', onClick: this.handleClickPrevious.bind(this), style: { cursor: 'pointer' } },
          this.displayingMinMonth.call(this) ? null : this.props.previousButtonElement
        ),
        _react2.default.createElement(
          'span',
          null,
        ...
        _react2.default.createElement(
          'div',
          { className: 'text-muted pull-right datepicker-next-wrapper', onClick: this.handleClickNext.bind(this), style: { cursor: 'pointer' } },
          this.displayingMaxMonth.call(this) ? null : this.props.nextButtonElement
        )
      );
    }
  }]);
...
var DatePicker = function (_Component3) {
  _inherits(DatePicker, _Component3);
  ...
  function DatePicker(props) {
    ...
    _this4.makeDateValues = _this4.makeDateValues.bind(_this4);
    ...
    _this4.getValue = _this4.getValue.bind(_this4);
    _this4.getFormattedValue = _this4.getFormattedValue.bind(_this4);
    _this4.getCalendarPlacement = _this4.getCalendarPlacement.bind(_this4);
    _this4.makeInputValueString = _this4.makeInputValueString.bind(_this4);
    ...
    if (_this4.props.value && _this4.props.defaultValue) {
      throw new Error('Conflicting DatePicker properties \'value\' and \'defaultValue\'');
    }
    _this4.state = _this4.makeDateValues(_this4.props.value || _this4.props.defaultValue);
    if (_this4.props.weekStartsOn > 1) {
      _this4.state.dayLabels = _this4.props.dayLabels.slice(_this4.props.weekStartsOn).concat(_this4.props.dayLabels.slice(0, _this4.props.weekStartsOn));
    } else if (_this4.props.weekStartsOn === 1) {
      _this4.state.dayLabels = _this4.props.dayLabels.slice(1).concat(_this4.props.dayLabels.slice(0, 1));
    } else {
      _this4.state.dayLabels = _this4.props.dayLabels;
    }
    _this4.state.focused = false;
    _this4.state.inputFocused = false;
    _this4.state.placeholder = _this4.props.placeholder || _this4.props.dateFormat;
    _this4.state.separator = _this4.props.dateFormat.match(/[^A-Z]/)[0];
    return _this4;
  }
